...
from housinginsights.ingestion.make_draft_json import (
    _sql_name_clean,
    _pandas_to_sql_data_type,
    make_draft_json,
    make_all_json,
)
...
class TestMakeDraftJson(unittest.TestCase):
    ...
    def test_make_draft_json(
        self, mock_read_csv, mock_pandas_to_sql_data_type, mock_open
    ):
