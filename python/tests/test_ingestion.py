...
class IngestionTests(unittest.TestCase):
    ...
    def test_file_checking(self):
        ...
        META_FILENAME = os.path.join(
            os.path.dirname(__file__), "test_data/meta_sample.json"
        )
        meta = load_meta_data(META_FILENAME)
        table_name = "buildings"

        MANIFEST_FILENAME = os.path.join(
            os.path.dirname(__file__), "test_data/manifest_sample.csv"
        )
    ...
    def test_unique_manifest_ids(self):
        ...
        MANIFEST_FILENAME = os.path.join(
            os.path.dirname(__file__), "test_data/manifest_unique.csv"
        )
        ...
        MANIFEST_FILENAME = os.path.join(
            os.path.dirname(__file__), "test_data/manifest_duplicates.csv"
        )
