...
###############################
# Initialize global objects needed for ingestion scripting
###############################
...
def weekly_update(database_choice=None, drop_tables_first=False):
    if database_choice is not None:
        manifest.set_database_choice = database_choice

    load_data.reload_all_from_manifest(use_clean=False,
                                       drop_tables=drop_tables_first,
                                       load_dependents=True)

###############################
# OLD PREVIOUS CODE TO BE REMOVED
###############################
