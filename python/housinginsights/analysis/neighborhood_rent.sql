WITH rent_joins AS (
    ...
    FROM project
        INNER JOIN census_mapping ON project.geo2020 = census_mapping.prescat_code
        INNER JOIN acs_rent_median ON census_mapping.acs_code::TEXT = acs_rent_median.geo_id2::TEXT
        INNER JOIN acs_rent_lower ON census_mapping.acs_code::TEXT = acs_rent_lower.geo_id2::TEXT
        INNER JOIN acs_rent_upper ON census_mapping.acs_code::TEXT = acs_rent_upper.geo_id2::TEXT
),
acs_14_rent AS (
    SELECT *
    FROM rent_joins
