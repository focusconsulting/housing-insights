...
class MarApiConn(BaseApiConn):
    ...
    def reverse_geocode(self, xcoord, ycoord, output_type=None, output_file=None):
        """
        ...
        :rtype: String
        """
        params = {"f": "json", "x": xcoord, "y": ycoord}
    ...
    def get_condo_count(self, location, output_type=None, output_file=None):
        """
    ...
    def get_condo_info(self, location, output_type=None, output_file=None):
        pass  # TODO
    ...
    def reverse_lat_lng_geocode(
        self, latitude, longitude, output_type=None, output_file=None
    ):
        """
        ...
        :rtype: json
        """
        params = {"f": "json", "lat": latitude, "lng": longitude}
