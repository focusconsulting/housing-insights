...
class CensusApiConn(BaseApiConn):
    ...
    def __init__(self, baseurl=None, proxies=None, database_choice=None, debug=False):
        ...
        self._fields = {
            ...
            "acs5_2020": "NAME,B01003_001E,B25057_001E,B25058_001E,B25059_001E,B02001_003E,B17020_002E,B19025_001E,B23025_002E,B16008_019E,B09002_015E",
            "acs5_2022": "NAME,B01003_001E,B25057_001E,B25058_001E,B25059_001E,B02001_003E,B17020_002E,B19025_001E,B23025_002E,B16008_019E,B09002_015E",
    ...
    def get_data(self, unique_data_ids=None, sample=False, output_type="csv", **kwargs):
        ...
        for u in unique_data_ids:
            if u not in self._available_unique_data_ids:
                ...
                logger.info(
                    "  The unique_data_id '%s' is not supported by the CensusApiConn", u
                )
            else:
                result = self.get(
                    self._urls[u],
                ...
                if result.status_code != 200:
                    err = "An error occurred during request: status {0}".format(
                        result.status_code
                    )
