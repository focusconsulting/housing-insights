...
`\scripts`
Folder for Python scripts used for processing data sources. Small static data is directed to the `\preservation-site\data` folder, but most of our source data will live on the Code for DC CKAN (see below).
