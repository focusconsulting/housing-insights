...
var model = {
  ...
  URLS: {
    ...
    metaData: 'http://localhost:5000/api/meta',
    filterData: 'http://localhost:5000/api/filter',
    project: 'http://localhost:5000/api/project',
    layerData:
      'http://localhost:5000/api/zone_facts/<source_data_name>/<grouping>'
  }
};
