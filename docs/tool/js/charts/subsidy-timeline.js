            ...
            function nullJudgment(){
              ...
              for(var i = 0; i < data.length; i++){
                if(data[i]['poa_start'] === null || data[i]['poa_end'] === null){
                  this.message = "Some subsidies have missing information for this property so the chart cannot be rendered. Check back with our final tool version September 2017.";
                  this.status = true;
                }
              }
            }
